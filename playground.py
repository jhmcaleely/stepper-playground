...
def accelmove(t):
    ...
    if accel > 3900:
        ...
        if accel % 32 == 0:
            syncstep()
            return
    elif accel < 3900 and accel > 3800 and accel % 16 == 0:
        print("HELLO")
        syncstep()
        return
    elif accel < 3800 and accel > 3600 and accel % 8 == 0:
        print("HELLO8")
        syncstep()
        return
    elif accel < 3600 and accel > 3400 and accel % 4 == 0:
        print("HELLO4")
        syncstep()
        return
    elif accel < 3400 and accel > 3200 and accel % 2 == 0:
        print("HELLO2")
        led2.on()
        syncstep()
        return
    elif accel < 3200 and accel > 1500:
        led2.off()
        syncstep()
        return
...
setupbutton(button2, startaccelrotate)
